<template>
  <div class="trade-view">
    <div class="trade-view__title">
      <h1 class="trade-view__title-text">
        {{ T("YOUR_TRADE") }}
      </h1>
    </div>
    <div class="trade-view__resources">
      <h2 class="trade-view__resources-title">
        {{ T("CURRENT_RESOURCES") }}
      </h2>
    ...
    <div class="trade-view__select">
      ...
      <trade-action v-for="option in tradeOptions" :key="option.resource" :resource="option.resource" :ratio="option.ratio" @addTrade="addTrade" />
    </div>
    <div class="trade-view__actions">
      ...
      <button v-if="tradeActions" class="trade-view__clear-button" @click="clearActions">
        {{ T("CLEAR_TRADE") }}
      </button>
    </div>
    ...
    <div class="trade-view__finish">
      <button class="trade-view__finish-button" @click="sendClientResponse">
        {{ T("FINISH_TRADE") }}
      </button>
    </div>
  </div>
...
export default {
  ...
  computed: {
    ...
    tradeResult: function () {
      let result = _cloneDeep(this.me.attributes.resources);
